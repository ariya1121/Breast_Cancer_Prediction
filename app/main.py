...
def get_clean_data():
    data = pd.read_csv("C:/Users/Administrator/Desktop/BCD/data/data.csv")
...
def add_predictions(input_data):
    model = pickle.load(open("C:/Users/Administrator/Desktop/BCD/model/model.pkl", "rb"))
    scaler = pickle.load(open("C:/Users/Administrator/Desktop/BCD/model/scaler.pkl", "rb"))
...
def main():
    ...
    with open("C:/Users/Administrator/Desktop/BCD/app/assets/style.css") as f: css = f.read()
    ...
    with st.container():
        ...
        st.write("This app predicts using a machine learning model whether a breast mass is benign or malignant. You can update the measurements using the sidebar.")
    ...
    with col2:
        add_predictions(input_data)  # Pass the input_data argument here
